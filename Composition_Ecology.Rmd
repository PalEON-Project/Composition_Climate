...
source('R/figures//ordination_plot.R')
ordi_plot

```

When we examine the taxa seperately we can see that by far the majority of comparisons show greater differences due to climate change than due to shifts in distribution:
