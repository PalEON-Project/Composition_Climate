...
The shifts in distribution to lead to changes in the apparent climate envelopes of the taxa, but these are dwarfed by the shifts in regional climate across the area.
...
ggplot(all.hellinger, aes(x = fixedv_c, y = fixedc_v, color = climate)) +
  geom_point(size = 2) + geom_abline(intercept=0, slope = 1) + facet_wrap(~shift) +
