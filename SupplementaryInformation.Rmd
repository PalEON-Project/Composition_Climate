...
<!-- COM: For TMax, why does the sign of the vegetation change flip from negative to positive between Table 1 and this Supp Table 4?  I can understand why the sign of the climate change would alter as we play around with different climate normals, but the sign of the vegetation change should be stable.  The other climate variables seem to be unaffected.  This may be the bug you mentioned by email.   -->
